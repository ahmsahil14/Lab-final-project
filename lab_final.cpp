...
int main()
{
    ...
    do
    {
        ...
        {
            // Game logic
            string words[] = {"Laptop", "programming", "cplusplus", "developer", "coding",
            ...
            string clues[] = {"WE use it for many reguler in our university and carry it in our bag", "The act of writing code", "A programming language", "One who writes code", "Creating software",
